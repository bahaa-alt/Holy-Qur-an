...
export const THEME_TOPICS: TopicDefinition[] = [
  ...
  },
  {
    ...
    labelAr: "الحج",
    category: "theme",
    note: "عمر (ʿumrah) shares its root with \"age/lifespan\"; some matches will be unrelated to pilgrimage.",
    sources: [root("حجج"), root("طوف"), root("عمر")],
  },
  {
    slug: "fasting",
  ...
  },
  {
    ...
    category: "theme",
    note: "صدق also covers \"truth/sincerity\" generally; not every match is about almsgiving.",
    sources: [root("زكو"), root("صدق")],
  },
  {
    slug: "inheritance",
    labelEn: "Inheritance",
  ...
  {
    slug: "paradise-jinn-and-gardens",
    labelEn: "Paradise, Jinn & Gardens",
    labelAr: "الجنة والجن",
    category: "theme",
    note: "جنن covers جنة (garden/paradise), جن (jinn) and مجنون (madness) -- one root, three unrelated senses.",
    sources: [root("جنن")],
  },
  {
    slug: "punishment",
