...
export const ar: Dict = {
  ...
  flashcardsPage: {
    ...
    subtitle: "تدريب بسيط بالتكرار المتباعد على الجذور أو الكلمات -- التقدّم يبقى على هذا الجهاز، بلا حسابات.",
    deckRoots: "الجذور",
    deckLemmas: "الكلمات",
    flip: "أظهر المعنى",
    again: "مجددًا",
    ...
    good: "جيد",
    easy: "سهل",
    sessionComplete: (n) => `اكتملت الجلسة -- تمت مراجعة ${n.toLocaleString()} بطاقة.`,
    noCardsDue: "لا بطاقات مستحقة الآن -- عد لاحقًا.",
    startSession: "ابدأ الجلسة",
    cardOf: (current, total) => `البطاقة ${current} من ${total}`,
  },
  insightsPage: {
    title: "إحصاءات",
    subtitle:
    ...
    formulasDescription:
      "تتابعات كلمات تتكرر بما يكفي، بنفس الألفاظ تمامًا، لتكون مرشحة كتعبيرات ثابتة -- يسمّي علم البلاغة القرآني الكلاسيكي هذا التكرار. نوافذ منزلقة من 2 إلى 6 كلمات متتالية داخل الآية الواحدة فقط، لا تتجاوز حدود الآية أبدًا؛ التراكيب الأقصر تحتاج تكرارًا أعلى لتتأهل، لأنها تتكرر أكثر بمحض الصدفة النحوية.",
  ...
  aboutPage: {
    ...
    formulasMethodBody:
      "لكل آية، يُطبَّع ويُحتسب كل تتابع متصل من 2 و3 و4 و5 و6 كلمات (نافذة منزلقة لا تتجاوز الآية التالية أبدًا) عبر القرآن كاملاً؛ يُرتَّب كل طول على حدة، بحيث يظهر تركيب من كلمتين والتركيب من 3 كلمات المحتوي عليه كإدخالين منفصلين. التراكيب الأقصر تحتاج تكرارًا أكبر لتتأهل (حدود دنيا 10/6/4/3/3 ورودًا للأطوال 2-6) لأن التتابعات القصيرة تتكرر أكثر بمحض الصدفة النحوية وحدها؛ تُعرض أفضل 25 تركيبًا لكل طول، ويربط كل منها بصفحة تسرد كل ورود له مع نص الآية كاملاً.",
