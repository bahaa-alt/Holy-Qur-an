...
export const ar: Dict = {
  ...
  insightsPage: {
    ...
    patternsScopedNote:
      "بنى الجذور دقيقة في أي نطاق. أما أعداد أوزان الأفعال والتصنيفات فتعتمد على التصنيف المعتاد لصيغة الكلمة لا على وسم هذا الورود بعينه (الطريقة نفسها التي يعتمدها البحث المتقدم) -- فاسم الفاعل أو المصدر يحمل وسم الوزن نفسه الذي يحمله فعله، فالتصنيف هو ما يميّز بينهما. يقارب هذا عادةً أرقام القرآن كله أعلاه، وقد يختلف عنها حين يتغيّر تصنيف الكلمة فعلاً بحسب السياق.",
