...
export const ar: Dict = {
  ...
  insightsPage: {
    ...
    collocationSigExplanation:
      "والرقم الأصغر أسفله هو قيمة q بطريقة Benjamini-Hochberg لضبط معدل الاكتشاف الزائف، من اختبار G² للترابط نفسه (Dunning 1993، اختبار دلالة التلازم الأصلي): أهذا الاقتران رابطة حقيقية على الأرجح أم قد يكون محض صدفة، مُصحَّحًا عبر كل أزواج الفعل وحرف الجر المتتبَّعة.",
