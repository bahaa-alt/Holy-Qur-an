...
export const ar: Dict = {
  ...
  advancedSearchPage: {
    title: "البحث المتقدم",
    subtitle:
      "اجمع بين عدة معايير عبر المدونة كاملة -- الفئة، صيغة الفعل، جذر معيّن، نطاق سور، والمكي/المدني -- للعثور على ما لا تستطيع صفحة جذر واحد وحدها الإجابة عنه، مثل كل اسم مفعول من الصيغة الثامنة في السور المدنية.",
    loading: "جارٍ تحميل فهرس المدونة…",
    categoryLabel: "الفئة",
    verbFormLabel: "صيغة الفعل",
    rootLabel: "الجذر",
    rootPlaceholder: "اكتب جذرًا لتضييق النتائج…",
    rootClear: "إزالة الجذر",
  ...
  insightsPage: {
    ...
    formulasShowingFirstRefs: (n) => `عرض أول ${n.toLocaleString()}`,
  },
  surahPage: {
    previous: "السابقة",
    next: "التالية",
  ...
  aboutPage: {
    ...
    collocationsMethodBody:
      "لكل ورود لجذر فعل، يُتحقّق مما إذا كانت الكلمة التالية مباشرةً -- أو، في حالة لاصقة من حرف واحد مثل بِ/لِ/كَ، مقطع البادئة المتصل بتلك الكلمة -- أحد عشرة حروف جر عربية أساسية (ب ل ك من إلى على في عن مع حتى). الاقتصار على هذه القائمة بدلاً من أي أداة تالية يجعل النتيجة تعكس التعدي النحوي للفعل تحديدًا، لا مجاورة عرضية لحرف عطف أو نفي أو استفهام.",
    abjadMethodHeading: "حساب الجُمَّل (القيمة العددية للحروف)",
    abjadMethodBody:
      "يجمع قيمة كل حرف في نظام الترقيم العربي الكلاسيكي ذي الثمانية والعشرين حرفًا (أبجد هوز حطي...)، بعد حذف التشكيل وتوحيد صور الألف وحاملات الهمزة (أ إ آ ٱ ء ؤ ئ) إلى ا، وتاء التأنيث المربوطة (ة) إلى ه، والألف المقصورة (ى) إلى ي -- إذ لا قيمة منفصلة للهمزة في هذا النظام الذي يسبق ظهورها كحرف مستقل.",
