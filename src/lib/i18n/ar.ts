...
export const ar: Dict = {
  ...
  namePhrasesTab: {
    description:
      "كل آية تحوي إحدى هذه العبارات في أي موضع من نصها -- نداءات مباشرة لله، وإشارات بضمير المتكلم أو المخاطب إليه بوصفه \"ربًا\"، وسلسلة من تراكيب حرف جر + الله/\"ربك\". قائمة مُنتقاة يدويًا، وليست نتيجة مسح تكراري آلي.",
