...
export const ar: Dict = {
  ...
  namesPage: {
    title: "أسماء الله",
    subtitle:
      "أسماء الله الحسنى وصفاته التسعة والتسعون التقليدية، بقدر ما يسمح هذا المصدر بعزلها بوضوح -- إضافة إلى كيفية اقترانها ببعضها وكيف تميل الآيات التي تستحضر الله إلى الافتتاح.",
    tabNames: "الأسماء",
    tabPairs: "الأسماء المقترنة",
    tabOpenings: "آيات الافتتاح",
  },
  namePairsTab: {
    description:
  ...
  openingPhrasesTab: {
    description:
      "كل آية يبدأ نصها العربي حرفيًا بإحدى هذه العبارات -- نداءات مباشرة لله، وإشارات بضمير المتكلم أو المخاطب إليه بوصفه \"ربًا\"، وبعض تراكيب الافتتاح المتكررة. قائمة مُنتقاة يدويًا، وليست نتيجة مسح تكراري آلي.",
    loading: "جارٍ تحميل الآيات…",
    versesCount: (n) => `${n.toLocaleString()} آية`,
    noResults: "لا توجد آية تبدأ بهذه العبارة.",
    pickPrompt: "اختر عبارة أعلاه لرؤية كل آية تبدأ بها.",
  },
  insightsPage: {
    title: "إحصاءات",
    subtitle:
