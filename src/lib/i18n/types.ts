...
export interface Dict {
  ...
  insightsPage: {
    ...
    compare: {
      ...
      keynessHeadingUnder: string;
      dispersionHeading: string;
      dispersionIntro: string;
      summary: (verses: number, tokens: number, referenceTokens: number) => string;
      correctionNote: (tests: number, alpha: string) => string;
      fdrCorrectionNote: (shown: number, alpha: string) => string;
      correctionMethodLabel: string;
      correctionBonferroni: string;
      correctionFdr: string;
      nsNote: string;
      ...
      colDp: string;
      colSpread: string;
      colSignificance: string;
      colSignificanceHint: string;
      testSignificance: string;
      testingSignificance: string;
      significanceResult: (p: number, permutations: number) => string;
      sig: { corrected: string; p001: string; p01: string; p05: string; ns: string };
      methodsHeading: string;
      methodsBasis: string;
      methodsG2: string;
      methodsLogRatio: string;
      methodsCI: string;
      methodsCorrection: string;
      methodsDp: string;
      methodsPermutation: string;
      methodsLimits: string;
    };
    tabFacts: string;
    tabLetters: string;
    tabRhyme: string;
  ...
  aboutPage: {
    ...
    keynessMethodHeading: string;
    keynessMethodBody: string;
    dispersionMethodHeading: string;
    dispersionMethodBody: string;
    letterFrequencyMethodHeading: string;
    letterFrequencyMethodBody: string;
    changelogHeading: string;
    changelogIntro: string;
    changelogUnreleasedLabel: string;
